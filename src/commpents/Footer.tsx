...
<footer className="p-4  sm:p-6 dark:bg-gray-800 w-">
  <div className="md:flex mx-auto">
    <div className="mb-6 md:mb-0">
      <a href="" target="_blank" className="flex items-center">
      <img className='pl' src="https://i.pinimg.com/originals/36/1a/ed/361aedc1b97dc88e8ce8c954d6619391.gif" width="150px" />
      </a>
    </div>
    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
      ...
      <div>
        <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Address</h3>
        <ul>
          <li className="mb-4">
  ...
  <div className="sm:flex sm:items-center sm:justify-between">
    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" target="_blank" className="hover:underline">Honda</a>. All Rights Reserved.
</span>
