...
const Navwebsite = (props: Props) => {
  return (
    ...
    <div>
      ...
      <img className='pl' src="https://i.pinimg.com/originals/36/1a/ed/361aedc1b97dc88e8ce8c954d6619391.gif" width="300px" />

        <a href="/" className="text-gray-800 text-2xl  dark:text-gray-200 border-b-2 border-blue-500 mx-1.5 sm:mx-6">home</a>
        ...
        <a href="/signup" className=" text-2xl    border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6"><i className="fa-solid fa-user pl-8"></i></a>
